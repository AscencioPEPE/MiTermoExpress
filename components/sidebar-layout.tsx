...
export default function SideBarLayout({ children }: SideBar) {
  ...
  return (
    <>
      <div className="bg-[url('/images/background.jpg')] bg-cover bg-fixed bg-center">
        ...
        <div className="lg:pl-72">
          ...
          <main className="size-full py-10">
            <div className="size-full px-4 sm:px-6 lg:px-8">{children}</div>
          </main>
        </div>
      </div>
    </>
