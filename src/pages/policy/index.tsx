const Policys = () => {
  return (
    <div>
      ...
      <p>
        El presente Política de Privacidad establece los términos en que Arte Termos usa y protege la información que es
      ...
      <p>
        Nuestro sitio web emplea la informacióna con el fin de proporcionar el mejor servicio posible, particularmente
      ...
      <p>
        Arte Termos está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
      ...
      <p>
        ...
        lo tanto no somos responsables de los{' '}
      ...
      <p>
        Arte Termos Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
        momento.
      </p>
      <p>
